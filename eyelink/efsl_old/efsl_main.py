...
if __name__ == '__main__':
    ...
    host = 'localhost'
    port = 52251
    # data = b'{"type": "pattern", "esIndex": "corecode", "docType": "corecode", "sDate": "2018-04-12T09:00:00", "eDate": "2018-04-13T00:00:00", "tInterval": 1, "nCluster": 30}'
    # SocketThread(host, port).jsonParsing(data)
    SocketThread(host, port).listen()